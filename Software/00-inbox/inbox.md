...
- [ ] criar nota [[Composite Index]] — quando um índice `(a, b)` substitui dois índices separados
- [ ] [[Teorema CAP]] — dizer que P não é opcional em sistema distribuído: a escolha real é CP ou AP, e "CA" só descreve um nó só
